...
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 8)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_8,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 9)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_9,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 10)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_10,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 11)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_11,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 12)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_12,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 13)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_13,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 14)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_14,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 15)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_15,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 16)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_16,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 17)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_17,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 18)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_18,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 19)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_19,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 20)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_20,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 21)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_21,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 22)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_22,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 23)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_23,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 24)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_24,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 25)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_25,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 26)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_26,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 27)
#else
    (flash_dm_ptr_t)FLASH_DF_BLOCK_27,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 28)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_28,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 29)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_29,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 30)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_30,
#if (FLASH_DM_CFG_DF_BLOCK_NUM == 31)
#else
    /* cast from uint32_t to flash_dm_ptr_t */
    (flash_dm_ptr_t)FLASH_DF_BLOCK_31

#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 31) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 30) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 29) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 28) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 27) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 26) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 25) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 24) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 23) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 22) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 21) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 20) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 19) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 18) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 17) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 16) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 15) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 14) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 13) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 12) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 11) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 10) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 9) */
#endif /* (FLASH_DM_CFG_DF_BLOCK_NUM == 8) */
