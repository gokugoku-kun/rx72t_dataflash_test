...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_flash_rx660.h
* Description  : This file contains equates for memory layout and timing constraints for
*                Code Flash (CF)/ROM and Data Flash (DF) on RX660 MCUs.
***********************************************************************************************************************/
/***********************************************************************************************************************
* History : DD.MM.YYYY Version Description
*         : 23.12.2021 4.90    First Release
***********************************************************************************************************************/

#ifndef R_FLASH_RX660_H
#define R_FLASH_RX660_H
...
#if (MCU_CFG_PART_MEMORY_SIZE == 0x09 )
 #define FLASH_NUM_BLOCKS_CF (38)
#elif (MCU_CFG_PART_MEMORY_SIZE == 0x04)
 #define FLASH_NUM_BLOCKS_CF (22)
#endif
...
#if MCU_CFG_PART_MEMORY_SIZE >= 0x09        /*  0x09 parts 1M ROM             */
...
#endif /* MCU_CFG_PART_MEMORY_SIZE >= 0x09 */
    FLASH_CF_BLOCK_INVALID = FLASH_CF_BLOCK_END - (FLASH_CF_SMALL_BLOCK_SIZE  * 8)
                                                - (FLASH_CF_MEDIUM_BLOCK_SIZE * (FLASH_NUM_BLOCKS_CF - 8)),
...
#define WAIT_MAX_ROM_WRITE \
        ((int32_t)(15800 * (4.0/(MCU_CFG_FCLK_HZ/1000000)))*(MCU_CFG_ICLK_HZ/1000000))
...
#define WAIT_MAX_ERASE_CF_32K \
        ((int32_t)(1040000 * (4.0/(MCU_CFG_FCLK_HZ/1000000)))*(MCU_CFG_ICLK_HZ/1000000))
...
#define WAIT_MAX_ERASE_CF_8K \
        ((int32_t)(260000 * (4.0/(MCU_CFG_FCLK_HZ/1000000)))*(MCU_CFG_ICLK_HZ/1000000))

/*  According to HW Manual the Max Erasure Time for a 64B Data Flash block is
    around 18ms.  This is with a FCLK of 4MHz. The calculation below
    calculates the number of ICLK ticks needed for the timeout delay.
    The 18ms number is adjusted linearly depending on the FCLK frequency.
*/
#define WAIT_MAX_ERASE_DF \
        ((int32_t)(18000 * (4.0/(MCU_CFG_FCLK_HZ/1000000)))*(MCU_CFG_ICLK_HZ/1000000))

#endif /* R_FLASH_RX660_H */
