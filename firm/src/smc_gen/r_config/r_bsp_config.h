...
*         : 31.07.2020 3.03      Modified comment.
*         : 20.11.2020 3.04      Added the following macro definition.
*                                 - BSP_CFG_ID_CODE_ENABLE
*         : 29.01.2021 3.05      Added the following macro definition.
...
*                                 - BSP_CFG_SWINT_UNIT1_ENABLE
*                                 - BSP_CFG_SWINT_UNIT2_ENABLE
*         : 25.11.2022 4.02      Modified comment.
***********************************************************************************************************************/
...
/* Group name.
   ...
   2T           = RX72T Group
*/
#define BSP_CFG_MCU_PART_GROUP          "RX72T" /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_PLL_DIV                 (3) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_PLL_MUL                 (16.0) /* Generated value. Do not edit this manually */
...
/* Peripheral Module Clock C Divider (PCKC).
   Available divisors = /1 (no division), /2, /4, /8, /16, /32, /64
*/
#define BSP_CFG_PCKC_DIV                (1) /* Generated value. Do not edit this manually */
...
/* External Bus Clock Divider (BCLK).
   Available divisors = /1 (no division), /2, /4, /8, /16, /32, /64
*/
#define BSP_CFG_BCK_DIV                 (4) /* Generated value. Do not edit this manually */
...
/* This macro is used to define the analog voltage that is supplied to the MCU (AVcc). This macro is defined in 
   ...
   NOTE: Set values appropriate for the user system.
 */
#define BSP_CFG_MCU_AVCC_MV                         (5000) /* Generated value. Do not edit this manually */
